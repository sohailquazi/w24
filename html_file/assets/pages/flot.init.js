...
!function($) {
    ...
    FlotChart.prototype.createDonutGraph = function(selector, labels, datas, colors) {
        ...
        FlotChart.prototype.init = function() {
            ...
            //Pie graph data
            var pielabels = ["Total Hours Worked","Total Hours Prospecting New Lead","Total Hours Prospecting Old Lead"];
            var datas = [60,40, 50];
            var colors = ['#23cbe0', '#0e86e7', "#f0f4f7"];
            this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);

            //Pie graph data
            var pielabels = ["Average Total Hours Worked","Average Total Hours Prospecting New Lead","Average Total Hours Prospecting Old Lead"];
            var datas = [60,40, 50];
            var colors = ['#23cbe0', '#0e86e7', "#f0f4f7"];
            this.createPieGraph("#pie-chart-1 #pie-chart-container-1", pielabels , datas, colors);
            ...
            var donutcolors = ['#0e86e7', '#23cbe0', "#f0f4f7"];
